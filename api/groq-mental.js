...
function consumeRateLimit(key, points) {
  ...
  if (!globalThis.__groqMentalRateLimit) {
    globalThis.__groqMentalRateLimit = new Map();
  }
  const bucket = globalThis.__groqMentalRateLimit.get(key) || [];
  ...
  globalThis.__groqMentalRateLimit.set(key, recent);
